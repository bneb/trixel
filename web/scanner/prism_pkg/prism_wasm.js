 ...
 */
export class PrismScanner {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        PrismScannerFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_prismscanner_free(ptr, 0);
    }
    constructor() {
        const ret = wasm.prismscanner_new();
        this.__wbg_ptr = ret >>> 0;
        PrismScannerFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     ...
     */
    scan_frame(rgba_data, width, height) {
        const ptr0 = passArray8ToWasm0(rgba_data, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.prismscanner_scan_frame(this.__wbg_ptr, ptr0, len0, width, height);
        let v2;
        if (ret[0] !== 0) {
...
if (Symbol.dispose) PrismScanner.prototype[Symbol.dispose] = PrismScanner.prototype.free;
 ...
 * @returns {string | undefined}
 */
export function decode_camera_frame(rgba_data, width, height) {
    const ptr0 = passArray8ToWasm0(rgba_data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.decode_camera_frame(ptr0, len0, width, height);
    let v2;
    if (ret[0] !== 0) {
        v2 = getStringFromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
 ...
 * @returns {Uint8Array}
 */
export function prism_embed_rgba(rgba_data, width, height, payload) {
    const ptr0 = passArray8ToWasm0(rgba_data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(payload, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.prism_embed_rgba(ptr0, len0, width, height, ptr1, len1);
    if (ret[3]) {
...
const PrismScannerFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_prismscanner_free(ptr >>> 0, 1));
