...
use trixel_core::{MockCodec, RsEcc, TernaryCodec, ErrorCorrection, LENGTH_PREFIX_TRITS};
use trixel_solver::{GaussSolver, MatrixSolver};
use trixel_solver::gauss_solver::{build_parity_check_matrix, grid_to_flat_coords};
...
fn miserable_work_encodes_with_sigh_constraints() {
    ...
    let constraints = TrixelFont::string_to_constraints(OVERLAY_TEXT, 5, 5);
