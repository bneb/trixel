//! # ternac_cv
//!
//! Computer vision pipeline for the Ternac system.
//! Extracts a `TritMatrix` from a photograph of a printed ternac code.
...
pub trait VisionPipeline {
    /// Extract the trit matrix from a ternac image.
