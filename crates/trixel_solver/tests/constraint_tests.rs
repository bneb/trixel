use trixel_solver::{AnchorSolver, ConstraintMask, MatrixSolver};
use trixel_solver::anchor::{ANCHOR_SIZE, corner_positions, ANCHOR_PATTERNS, is_in_anchor_region};
...
fn solver_with_font_constraints() {
    ...
    let text = "HI";
    let constraints = TrixelFont::string_to_constraints(text, 4, 4);
